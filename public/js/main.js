...
(function() {
  var animate, bkg, bkg_ctx, calculateFps, canvas, ctx, draw, erase, fps, fpsDisplay, initClickHandlers, initModules, lastFpsUpdateTime, lastTime, lastkeyDown, metrics, missleFactory, paused, renderStatics, stateEngine;
  ...
  initModules = function() {
    ...
    return missleFactory = new MissleFactory(20).buildMissles(missleOrigin);
  };
  ...
  initClickHandlers = function() {
    return ctx.canvas.addEventListener('click', function(event) {
      ...
      if (missle != null) {
        ...
        stateEngine.addActor(missle, function() {
          return missleFactory.recycle(missle);
        });
